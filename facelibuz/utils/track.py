import numpy as np
from facelibuz.utils.kalman_tracker import KFTracker2D, KFTrackerSORT, KFTracker4D
...
class Track:
    ...
    def update(self, frame_id, bbox, detection_confidence, class_id=None, lost=0, iou_score=0., **kwargs):
        ...
        self.detection_confidence_max = detection_confidence #max(self.detection_confidence_max, detection_confidence)
